...
public class SelectedMember {
	...
	public SelectedMember(String name, String address, String contactParson, String tata, String mobile, String fax, String residential, String email, String web) {
		this.name = name;
